...
SUBMISSION_DIR = '/opt/ml/workspace/submission_deformed.csv'
NEW_SUBMISSION_DIR = 'submission_deformed2.csv'
...
if __name__ == '__main__':
    resize_bbox(original=(512,512),deformed=(1024,1024),submission_dir=SUBMISSION_DIR,new_submission_dir=NEW_SUBMISSION_DIR)
